...
public class JuheDemo {
    ...
    //配置您申请的KEY
//    public static final String APPKEY ="f33753ce8f92ccd7cc10d150eea73928";
//    public static final String APPKEY =Utils.getStringFromStream(new FileInputStream(new File("juhe_appkey.txt")));
 
    //1.识别验证码
  public static String post(String type,File file) throws Exception{
	  		String APPKEY =Utils.getStringFromStream(new FileInputStream(new File("juhe_appkey.txt"))).split("\n")[0];
...
//                e.printStackTrace();
            ...
            if(object.getInt("error_code")==0){
                ...
                result = object.get("reason").toString();
            }
            return result;
       }
